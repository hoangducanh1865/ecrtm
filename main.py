...
from src.utils.data.TextData import TextData
from src.utils.data import file_utils
...
def main():
    ...
    beta = trainer.train(dataset_handler.train_loader)
    ...
    train_theta = trainer.test(dataset_handler.train_data)
    test_theta = trainer.test(dataset_handler.test_data)
